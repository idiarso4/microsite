        ...
        <Card sx={{ 
          ...
          <Box sx={{ 
            ...
            <Box sx={{ 
              ...
              <LocalShipping sx={{ fontSize: 48, mr: 2 }} />
            ...
            <Typography variant="body2" sx={{ opacity: 0.8, mt: 1 }}>
              Kelola pengadaan dengan sistem yang efisien
            </Typography>
          </Box>
          ...
          <CardContent sx={{ p: 4 }}>
              ...
              <Stack spacing={3}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <FormControlLabel
                    ...
                    label="Remember me"
                  />
                  <Link href="#" sx={{ color: '#9C27B0', textDecoration: 'none' }}>
                    Forgot password?
                  </Link>
                </Box>
            ...
            <Box sx={{ 
              ...
              <Typography variant="body2" color="text.secondary">
                Email: procurement@microsite.com<br />
